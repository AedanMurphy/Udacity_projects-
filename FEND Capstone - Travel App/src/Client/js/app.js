...
export async function genCoordinates(e) {
        e.preventDefault();
        const destination = document.getElementById("city-selected").value;
        const departure = document.getElementById("time-departure").valueAsDate; 
        const arrival = document.getElementById("time-arrival").valueAsDate;
        ...
        //postAllData 
                .then(function(data) {
                        ...
                        postAllData('http://localhost:8000/addApiData', {
        ...
        if (countdownDays <= 7) {
        weatherbitURL = weatherbit_CurrentURL;
        } else {
        weatherbitURL = weatherbit_ForecastURL;
        }
...
const UIupdate = async () => {
        ...
        document.getElementById('city').innerHTML = `City_Destination: ${reqAllData.city}`
        document.getElementById('departure_date').innerHTML = `Departure: ${reqAllData.departure_date}`
        document.getElementById('arrival_date').innerHTML = `Arrival: ${reqAllData.arrival_date}`
        document.getElementById('days_until_departure').innerHTML = `Countdown: ${reqAllData.flight_until}`
        document.getElementById('holiday_length').innerHTML = `Length_of_stay: ${reqAllData.holiday_length}`
        document.getElementById('Picture').innerHTML = `Image: ${reqAllData.Picture} `
